...
{
    public Material m_Material;                 // material to apply
    private GameObject m_PlanetMesh;            // mesh holder

    private List<Polygon> m_Polygons;             // list of all Polygons
    private List<Vector3> m_Vertices;             // list of all vertices

    public int m_Recursions;
    ...
    public void CreateIcosahedron()
    {
        ...
        // ... and 20 sides build out of thos 12 vertices
